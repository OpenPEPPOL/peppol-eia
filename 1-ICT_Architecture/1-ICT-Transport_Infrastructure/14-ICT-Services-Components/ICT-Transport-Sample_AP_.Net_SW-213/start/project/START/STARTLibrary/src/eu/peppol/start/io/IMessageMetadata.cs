...
namespace STARTLibrary.src.eu.peppol.start.io
{
    ...
    {
        ParticipantIdentifierType SenderIdentifier { get; set; }
        ParticipantIdentifierType RecipientIdentifier { get; set; }
        DocumentIdentifierType DocumentIdentifier { get; set; }
        ProcessIdentifierType ProcessIdentifier { get; set; }
