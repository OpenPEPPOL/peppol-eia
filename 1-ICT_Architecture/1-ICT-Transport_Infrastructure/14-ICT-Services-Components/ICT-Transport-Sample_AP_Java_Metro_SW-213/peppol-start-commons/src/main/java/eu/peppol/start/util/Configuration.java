...
public final class Configuration {
     ...
     * Properties path
     */
    private static String PROPERTIES_PATH = "/configStart.properties";
    ...
    private Configuration() {
        ...
        try {
            ...
            logger4J.error("No configuration file found (configStart.properties)", ex);
            Logger.getLogger(Configuration.class.getName()).log(Level.SEVERE, ex.getMessage());
            throw new
                    RuntimeException("No configuration file found (configStart.properties)");
        } finally {
            try {
                in.close();
            } catch (IOException ex) {
