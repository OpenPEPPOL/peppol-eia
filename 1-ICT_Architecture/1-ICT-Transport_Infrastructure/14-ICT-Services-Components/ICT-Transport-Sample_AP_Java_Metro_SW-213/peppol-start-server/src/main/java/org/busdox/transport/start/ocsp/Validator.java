 ...
 */
public class Validator implements CertificateValidator {

    /**
     * Logger to follow this class behavior.
     */
    private static org.apache.log4j.Logger logger4J =
            org.apache.log4j.Logger.getLogger(Validator.class);
    /**
    ...
    public final boolean certificateValidate(final X509Certificate x509Cert, final String path) {
        ...
        boolean valid = false;
            ...
            try {
                ...
                Logger.getLogger(Validator.class.getName()).log(Level.SEVERE, ex.getMessage());
